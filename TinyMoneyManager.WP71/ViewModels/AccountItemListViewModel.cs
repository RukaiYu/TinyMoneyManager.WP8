namespace TinyMoneyManager.ViewModels
{
    ...
    public class AccountItemListViewModel : NkjSoftViewModelBase
    {
        ...
        /// <summary>
        /// Gets the one budget month data.
        /// </summary>
        ...
        /// <returns></returns>
        public System.Collections.Generic.IEnumerable<AccountItem> GetOneBudgetMonthData(DateTime startDate, DateTime endDate)// int year, int month, int startDay, int endDay)
        {
            //var s_month = month;
            //var e_month = month;
            //var s_year = year;
            ...
            //var startDate = new DateTime(s_year, s_month, startDay);
            //var endDate = new DateTime(year, e_month, endDay);

            // l.16- c.15
            return (from accountItem in this.AccountBookDataContext.AccountItems
                    where (accountItem.CreateTime.Date >= startDate.Date && accountItem.CreateTime.Date <= endDate.Date)
                    select accountItem);
        }
