    ...
    public class SkyDriveDataSyncingPageViewModel : NkjSoftViewModelBase
    {
        ...
        public async void DownloadData()
        {
            ...
            else
            {
                ...
                var result = await this.LiveConnector.DownloadAsync(id + "/content?return_ssl_resources=true");

                LiveConnector_DownloadCompleted(result, userState);
            }
        }
        ...
        {
            var result = await this.LiveConnector.GetAsync("/me");

            getUserName_Callback(result);
        }
        ...
        internal async void UploadData()
        {
            ...
            else
            {
                ...
                var result = await this.LiveConnector.UploadAsync(parentId, fileNameRenamed, inputStream, OverwriteOption.Overwrite);

                LiveConnector_UploadCompleted(result);
