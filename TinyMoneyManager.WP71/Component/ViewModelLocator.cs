namespace TinyMoneyManager.Component
{
    ...
    public class ViewModelLocator
    {
        ...
        public static ViewModels.NotificationManager.NotificationsViewModel NotificationsViewModel
        {
            get
            {
                return instanceLoader.LoadSingelton<NotificationsViewModel>("NotificationsViewModel");
            }
        }
    }
}
