namespace TinyMoneyManager
{
    ...
    public partial class MainPage : PhoneApplicationPage, INotifyPropertyChanged
    {
        ...
        private void AfterPasswordPassed()
        {
            ...
            this.RecentItemList.Visibility = System.Windows.Visibility.Visible;
            App.HasLogined = true;
        ...
        private void InitializeSafeService()
        {
            ...
            this.safetyService.BeforePopupPasswordInputDialog = delegate
            {
                ...
                this.RecentItemList.Visibility = System.Windows.Visibility.Collapsed;
            };
        ...
        private void MainPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (!this.hasRunLoaded)
            {
                ...
                this.ShowTipsOnceDirectly("__tipsForHowToGetHelpWhenError",
                    AppResources.HowToGetHelpTitle, AppResources.HowToGetHelpMessage);
