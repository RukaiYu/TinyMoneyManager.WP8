namespace TinyMoneyManager
{
    ...
    public partial class App : Application
    {
        ...
        public const string MainVer = "2.0.2";
        public const string PCClinetAddress_SkyDrive = "https://skydrive.live.com/redir?resid=D9CB9D904309AE62!605";
        private bool phoneApplicationInitialized;
        public static string QuickNewRecordName = null;
        public static string SeniorVersion = "201.27";
        public static string SingleVersionInfo = ("2.0.2(" + SeniorVersion + ")");
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            else
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                   {
                       CommonExtensions.AlertConfirm(null, "{0}\r\n{1}".FormatWith(AppResources.FailedLoadingRequestRefresMsg,
                           AppResources.RequireSendingErrors), () =>
                       {
                           Helper.SendEmailToTeam("[{0}]-Error feedback.".FormatWith(AppResources.AppName, ""), e.ExceptionObject.Message + "\r\n" + e.ExceptionObject.ToString());
                       });

                       MessageBox.Show(AppUpdater.EnsureWhetherNeedToRebuildDataBase(e.ExceptionObject) + "\r\n" + AppResources.DeathFailedExceptionMessage.FormatWith(new object[] { "https://skydrive.live.com/redir?resid=D9CB9D904309AE62!605", e.ExceptionObject.Message }), AlertBoxTitle, MessageBoxButton.OK);
        ...
        {
            return string.Format("\r\nApp Version\\t\\t: {0}\r\nData base Version:\\t\\t{1}", SingleVersionInfo, DatabaseVersion.CurrentVersion);
        }
