namespace TinyMoneyManager.Pages
{
    ...
    public partial class DataSynchronizationPage : PhoneApplicationPage
    {
        ...
        private void ProcessSync()
        {
            ...
            {
                this.Alert(LocalizedStrings.GetLanguageInfoByKey("NeedIPandPortMessage").FormatWith(new object[] { "https://skydrive.live.com/redir?resid=D9CB9D904309AE62!605" }), null);
