namespace TinyMoneyManager.Pages.CategoryManager
{
    ...
    public partial class CategoryInfoViewer : PhoneApplicationPage, INotifyPropertyChanged
    {
        ...
        void CategoryInfoViewer_Loaded(object sender, RoutedEventArgs e)
        {
            if (!this._hasLoadCurrent)
            {
                this._hasLoadCurrent = true;
        ...
        private void LoadCurrent()
        {
            ...
            System.Threading.ThreadPool.QueueUserWorkItem(delegate(object o)
            {
                ...
                if (item == null)
                {
                    ...
                    {
                        this.Alert(AppResources.TheRecordMissing);
                        this.IsEnabled = false;
                        if (this.ApplicationBar != null)
                        {
                            this.ApplicationBar.IsVisible = false;
                            this.NameEditor.IsEnabled = false;
                        }
                    });
                    return;
                }
        ...
        {
            CanGo(() => SelectParentCategoryPage.Go(this, this.Current));
        }

        private bool CanGo(Action actionToGo, bool checkParent = true)
        {
            if (this.Current != null)
            {
                if (checkParent && current.IsParent && current.ParentCategory == null)
                {
                    this.Alert(AppResources.TheRecordMissingMessage);
                    return false;
                }
