...
namespace TinyMoneyManager.ViewModels.BudgetManagement
{
    public class BudgetProjectManagementViewModel : TinyMoneyManager.Component.NkjSoftViewModelBase
    {
        ...
        {
            var currentCategories = CurrentEditOrViewProject.BudgetItems.Select(p => p.BudgetTargetId).ToList();
            ...
            if (CurrentEditOrViewProject.Id == Guid.Empty)
            {
                ...
                {
                    ViewModelLocator.BudgetProjectViewModel.BugetItemsForAdd.Add(new BudgetItem()
                    {
                        Amount = 0.0m,
            ...
            else
            {
                foreach (var item in targetNews)
                {
                    ...
                    ViewModelLocator.BudgetProjectViewModel.BugetItemsForAdd.Add(budgetItem);
