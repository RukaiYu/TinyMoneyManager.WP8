namespace TinyMoneyManager.ViewModels
{
    ...
    public class GroupAccountItemViewModelBase<TKey> : ObservableCollection<AccountItem>
    {
        private TKey _key;
        ...
        public string TotalAmount
        {
            get
            {
                return AppSetting.Instance.DefaultCurrency.GetGloableCurrencySymbol(base.Items.Sum<AccountItem>(p => p.GetMoney()));
            }
        }
    }
}
