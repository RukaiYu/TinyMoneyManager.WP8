namespace TinyMoneyManager.ViewModels.DataSyncing
{
    ...
    public class XmlFileDataSyncingHandler : DataSyncingHandler<ObjectFromSkyDrive>
    {
        ...
        private void LiveConnector_GetCompleted(object sender, LiveOperationCompletedEventArgs e)
        {
            GlobalIndicator.Instance.WorkDone();
            ...
            {
                System.Collections.Generic.List<ObjectFromSkyDrive> source = base.Manager.DectingDataSyncingRootFolder(e);
        ...
        private void processRestore(bool encryptedData = false)
        {
            base.Manager.DownloadFile(string.Empty, base.DataFile.Id, delegate(System.IO.Stream fileStream)
            {
                if (fileStream != null)
                {
        ...
        public override void Restore(bool isDataEncrypted = false)
        {
            ...
            if ((base.DataFile == null) || base.DataFile.Id.IsNullOrEmpty())
            {
                ...
                base.Manager.LiveConnector.GetCompleted += new System.EventHandler<LiveOperationCompletedEventArgs>(this.LiveConnector_GetCompleted);
                base.Manager.LiveConnector.GetAsync("{0}/files".FormatWith(new object[] { base.Folder.Id }));
            }
            else
            {
