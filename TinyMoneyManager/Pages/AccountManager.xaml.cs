namespace TinyMoneyManager.Pages
{
    ...
    public partial class AccountManager : PhoneApplicationPage
    {
        ...
        {
            if (this.AlertConfirm(LocalizedStrings.GetLanguageInfoByKey("DeleteAccountItemMessage"), null, null) == MessageBoxResult.OK)
            {
        ...
        {
            TransferingItem tag = (sender as MenuItem).Tag as TransferingItem;
            if ((tag != null) && (((this.AlertConfirm(LocalizedStrings.GetLanguageInfoByKey("RevertWillDeleteItemConfirmMessage"), null, null) == MessageBoxResult.OK) && !this.transferingHistoryViewModel.Revert(tag)) && (this.AlertConfirm(LocalizedStrings.GetLanguageInfoByKey("CantRevertWhenAccountsNoExistsConfirmationMessage"), null, null) == MessageBoxResult.OK)))
            {
                this.transferingHistoryViewModel.DeleteItem(tag);
            }
        }
