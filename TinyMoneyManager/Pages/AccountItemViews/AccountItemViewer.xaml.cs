namespace TinyMoneyManager.Pages.AccountItemViews
{
    ...
    public partial class AccountItemViewer : PhoneApplicationPage, INotifyPropertyChanged
    {
            ...
            if (e.NavigationMode != NavigationMode.Back)
            {
                ...
                System.Threading.ThreadPool.QueueUserWorkItem(delegate(object o)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        {
                            System.Func<System.Guid, System.DateTime, AccountItem> func = null;
                            System.Func<System.Guid, System.DateTime, AccountItem> func2 = null;
                            this.CurrentObject = item;
                            if (this.CurrentObject.Type == ItemType.Expense)
                            {
                                if (func == null)
                                {
                                    func = delegate(System.Guid id, System.DateTime date)
                                    {

                                        return this.accountItemViewModel.FindGroup(this.accountItemViewModel.ExpenseItems, date).FirstOrDefault<AccountItem>(p => p.Id == id);
                                    };
                                }
                                this.sameTypeItemListGetter = func;
                            }
                            else
                            {
                                if (func2 == null)
                                {
                                    func2 = delegate(System.Guid id, System.DateTime date)
                                    {

                                        return this.accountItemViewModel.FindGroup(this.accountItemViewModel.IncomeItems, date).FirstOrDefault<AccountItem>(p => p.Id == id);
                                    };
                                }
        ...
        private void PicturesEditor_Click(object sender, RoutedEventArgs e)
        {
            ...
            PictureBrowser.Go(this.CurrentObject.Id, "AccountItmes", this);
        }
        ...
        public AccountItem CurrentObject { get; set; }
